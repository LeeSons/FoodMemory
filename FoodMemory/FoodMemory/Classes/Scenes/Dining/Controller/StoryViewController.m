...
- (void)setTopView{
    ...
    _btnBack.frame = CGRectMake(0, 0, kWindowWidth, 30);
    [_btnBack setTitle:@"返回" forState:(UIControlStateNormal)];
    _btnBack.titleLabel.textAlignment = NSTextAlignmentLeft;
    _btnBack.titleEdgeInsets = UIEdgeInsetsMake(50, -_btnBack.frame.size.width/2.0-100, 50, 30);
    ...
    [_btnBack setBackgroundColor:RgbColor(87, 172, 255)];
