...
- (void)viewDidLoad {
    [super viewDidLoad];
    UIImageView *imgView = [[UIImageView alloc] initWithFrame:CGRectMake(self.view.frame.size.width * -2, 0, self.view.frame.size.width * 3, self.view.frame.size.height)];
...
- (void)setAnimation:(UIView *)view{
    ...
    view.center = CGPointMake(self.view.frame.size.width * 0.8, self.view.center.y);
